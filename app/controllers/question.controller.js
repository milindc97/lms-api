...
exports.updateQuestion = (req,res)=>{
    Question.findByIdAndUpdate(req.params.id,{$set:{question: req.body.question,optionA: req.body.optionA,optionB: req.body.optionB,optionC: req.body.optionC,optionD: req.body.optionD,answer: req.body.answer,}},(err,data)=>{
        if(err){
